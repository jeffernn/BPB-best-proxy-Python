...
class DomainExtractorApp(ctk.CTk):
    def __init__(self):
        ...
        self.title("节点随机筛选工具 - By Jeffern")
    ...
    def process_file(self):
        ...
        try:
            ...
            # 随机打乱顺序
            random.shuffle(qualified_urls)

            # 应用数量限制
            if limit > 0:
                results = qualified_urls[:limit]
            else:
                results = qualified_urls
            ...
            save_path = os.path.join(save_dir, "2.筛选好的节点.txt")
